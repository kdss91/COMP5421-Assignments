...
/**It is used to test various commands on the contents of the filename passed as argument.
*@param string represents filename. If the file exits, it's contents are loaded. Otherwise, a new
*file is created.
**/
void testLineEd(const string& filename)
{
